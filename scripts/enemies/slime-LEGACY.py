from enemies.enemy_dumb import Enemy
...
class Slime(Enemy):
    def __init__(self, sprite, player_ref, pos=(0,0), collision_manager=None):
        ...
        if self.walking_right_anim == None:
            ...
            "../assets/../assets/cyberpunk-pack/slime.png", (8, 6), 2, scale=8, time=100)
            self.walking_left_anim = Animation(
            "../assets/../assets/cyberpunk-pack/slime.png", (8, 6), 2, scale=8, time=100, mirror=True)
