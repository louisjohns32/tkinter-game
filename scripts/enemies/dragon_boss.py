...
class DragonBoss(Enemy):
    ...
    def __init__(self, sprite, player_ref, pos=..., collision_manager=None):
        ...
        self._flying_right = Animation(
            "../assets/cyberpunk-pack/red-dragon.png", (144, 128), 3, scale=2, time=64, start=3)
        self._flying_left = Animation("../assets/cyberpunk-pack/red-dragon.png",
                             (144, 128), 3, scale=2, time=64, start=9)
        self._flying_up = Animation("../assets/cyberpunk-pack/red-dragon.png",
                           (144, 128), 3, scale=2, time=64)
        self._flying_down = Animation("../assets/cyberpunk-pack/red-dragon.png",
