...
class FireBreathProjectile(GameObject):
    ...
    def __init__(self, sprite, pos=(0, 0), dir="left"):
        ...
        self.animations = {
        "left": Animation("../assets/cyberpunk-pack/fire-breath.png", (64, 64), 9, time=16, scale=5, rotation=270),
        "right": Animation("../assets/cyberpunk-pack/fire-breath.png", (64, 64), 9, time=16, scale=5, rotation=90),
        "up": Animation("../assets/cyberpunk-pack/fire-breath.png", (64, 64), 9, time=16, scale=5, rotation=180),
        "down": Animation("../assets/cyberpunk-pack/fire-breath.png", (64, 64), 9, time=16, scale=5)
    }
