...
from game_state_machine.login_state import LoginState
from game_state_machine.input_state import InputState
...
class GameStateManager:
    def __init__(self, map_manager=None, input_handler=None, main_canvas=None):
        ...
        self.LOGIN.initialise_state()
        self.INPUT.initialise_state()
