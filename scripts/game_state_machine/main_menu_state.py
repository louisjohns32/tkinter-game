...
class MainMenuState(GameBaseState):
    def initialise_state(self):
        ...
        self.options = [("Start", lambda: self.change_state(self.state_manager.PLAYING)),("Login", lambda : self.change_state(self.state_manager.LOGIN) ), ("Leaderboard",lambda: self.change_state(self.state_manager.LEADERBOARD)),
